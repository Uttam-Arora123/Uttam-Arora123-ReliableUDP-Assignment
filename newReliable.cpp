...
//
//std::vector<unsigned char> readFileInBinaryChunks(const std::string& filename);
//
//class FlowControl
//{
//public:
...
//
//	
//	// -------------------------------------------------------------------------------------------------------- GET FILE NAME AS THE CLIENT / CHECK IF EXISTS
//	
...
//		file.close();
//
//		fileData = readFileInBinaryChunks(sendingFile);
//	}
//
//	// -------------------------------------------------------------------------------------------------------- 
//
...
//		file.close();
//		return {}; // Return an empty vector if file reading fails
//	}
//
//	file.close();
//	return fileData;
